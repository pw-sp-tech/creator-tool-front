...
document.querySelectorAll(".create-one2").forEach((el) =>
...
function sendForgotMail() {
  const mailId = forgotPassBox
    .querySelector(".email-div")
    .querySelector("input").value;
  if (!mailId) {
    showAlert2("Enter your email address");
  } else {
...
function changePass() {
  const changePass1 = changePassBox
    .querySelector(".pass-div")
    .querySelector("input").value;
  const changePass2 = changePassBox
    .querySelector(".pass2-div")
    .querySelector("input").value;
